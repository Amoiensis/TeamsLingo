  ...
  const STRINGS = {
    "zh-CN": {
      ...
      options: {
        ...
        testFailure: "测试失败。",
        updateTitle: "版本更新",
        updateDescription: "检查 GitHub 最新正式版；如有更新，可直接查看更新说明和更新指引。",
        updateCheck: "检查更新",
        currentVersion: "当前版本",
        latestVersion: "最新正式版",
        updateLatestUnknown: "未确认",
        updateChecking: "正在检查 GitHub 发布版本...",
        updateAvailable: "发现新版本，可直接查看更新说明和更新指引。",
        updateCurrent: "当前已是最新正式版本。",
        updateUnavailable: "因为无法访问项目发布网址，暂时无法确认是否有更新。",
        updateViewRelease: "更新说明",
    ...
    en: {
      ...
      options: {
        ...
        updateDescription: "Check the latest stable release on GitHub. When an update is available, you can open what's new and the update guide directly.",
        updateCheck: "Check for updates",
        currentVersion: "Current version",
        latestVersion: "Latest stable",
        updateLatestUnknown: "Not confirmed",
        updateChecking: "Checking GitHub releases...",
        updateAvailable: "A newer version is available. Open what's new and the update guide.",
        updateCurrent: "You are already on the latest stable release.",
        updateUnavailable: "The project release URL is currently unreachable, so update status cannot be confirmed.",
        updateViewRelease: "What's new",
    ...
    ja: {
      ...
      options: {
        ...
        testFailure: "テスト失敗。",
        updateTitle: "バージョン更新",
        updateDescription: "GitHub の最新正式版を確認します。更新がある場合は、更新内容と更新ガイドを直接開けます。",
        updateCheck: "更新を確認",
        currentVersion: "現在のバージョン",
        latestVersion: "最新正式版",
        updateLatestUnknown: "未確認",
        updateChecking: "GitHub Releases を確認中...",
        updateAvailable: "新しいバージョンがあります。更新内容と更新ガイドを確認できます。",
        updateCurrent: "現在のバージョンは最新正式版です。",
        updateUnavailable: "プロジェクトのリリース URL にアクセスできないため、更新の有無を確認できません。",
        updateViewRelease: "更新内容",
